...
namespace SS14.Server.Services.Atmos
{
    public class AtmosManager : IAtmosManager
    {
        ...
        public void SendAtmosStateTo(NetConnection client)
        {
            ...
            if (msg == null)
                return;
            IoCManager.Resolve<ISS14NetServer>().SendMessage(msg, client, NetDeliveryMethod.ReliableUnordered);
        }
        ...
        private void SendAtmosUpdatePacket(BitStream records)
        {
            ...
            if (msg == null)
                return;
            IoCManager.Resolve<ISS14NetServer>().SendToAll(msg, NetDeliveryMethod.Unreliable);
        }
        ...
        private NetOutgoingMessage CreateAtmosUpdatePacket(BitStream records)
        {
            ...
            if (recs == null)
                return null;
            NetOutgoingMessage msg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
